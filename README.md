## Container Documentation for Dotnet-Sdk Documentation

The CleanStart Dotnet-Sdk image provides a production-ready, security-hardened container optimized for enterprise environments. Built on a minimal base OS with comprehensive security hardening, this image delivers reliable application execution with advanced security features.
...
docker run -d --name dotnet-sdk-prod \
  ...
  ghcr.io/cleanstart-containers/dotnet-sdk:latest
```
